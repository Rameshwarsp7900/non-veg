          ...
          {(() => {
            ...
            return (
              <div className="space-y-4">
                ...
                {dayEvents.length > 0 && (
                  <div>
                    <h4 className="text-sm font-medium text-blue-900 mb-2">Events:</h4>
                    <div className="space-y-2">
                      {dayEvents.map(event => (
                        <div key={event.id} className="text-xs bg-white rounded p-2 border">
